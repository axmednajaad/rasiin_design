...
//         if ($target.hasClass('no-notifications')) return;
        
//         const log_name = $target.data('log-name');
//         if (this.processingNotifications.has(log_name)) return;
...
//                 setTimeout(() => this.processingNotifications.delete(log_name), 1000);
//             });
//     }
...
//                 return Promise.reject(r.message || "Unknown server error");
//             }
//             console.log("Notification marked as read:", log_name);
//         });
//     }

//     navigateToDocument(doc_type, doc_name) {
//         setTimeout(() => frappe.set_route('Form', doc_type, doc_name), 100);
//     }
